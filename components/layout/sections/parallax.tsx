...
const exampleImages: { url: string }[] = [
  { url: "https://yavuzceliker.github.io/sample-images/image-1.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-2.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-3.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-4.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-5.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-6.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-7.jpg" },
  { url: "https://yavuzceliker.github.io/sample-images/image-8.jpg" },
];
...
export const Parallax = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div
        className="flex relative w-4/5 h-96 justify-center items-center bg-black overflow-hidden rounded-2xl"
        ref={scope}
      >
        <motion.div
        ...
        >
          <p className="text-5xl md:text-7xl z-50 text-white italic">
            ta steget
          </p>
          <p className="text-xs z-50 hover:scale-110 transition-transform bg-white text-black rounded-full py-2 px-6 cursor-pointer">
            Lönekalkylator
          </p>
        </motion.div>
